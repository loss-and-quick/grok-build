...
pub use task::{
    ...
    REASONING_EFFORT_VALUES, SubagentCapabilityMode, SubagentCompletedOutput, SubagentDescriptor,
    ...
    canonical_reasoning_effort, default_subagent_type, format_resume_footer,
