...
pub use task::{
    ...
    is_not_sentinel, max_wait_block_ms, render_tool_access_fragment, resolve_task_ids,
    sanitize_optional_arg, should_continue_parent_work, subagent_failure_is_resumable,
