...
pub use task::{
    ...
    builtin_subagent_by_name, default_subagent_type, format_failed_resume_footer,
    ...
    resolve_task_ids, sanitize_optional_arg, should_continue_parent_work,
    subagent_failure_is_resumable, task_output_waits, task_output_waits_from_json,
};
pub use types::{
