...
pub use task::{
    ...
    PLAN_SUBAGENT, REASONING_EFFORT_VALUES, SubagentCapabilityMode, SubagentCompletedOutput,
    ...
    builtin_subagent_by_name, canonical_reasoning_effort, default_subagent_type,
    format_resume_footer, format_subagent_completed, format_subagent_started_background,
    format_wait_cap_ms, is_not_sentinel, max_wait_block_ms, resolve_task_ids,
    sanitize_optional_arg, should_continue_parent_work, task_output_waits,
