...
//! [`crate::single_flight::AuthSingleFlight`]:
//!
...
use crate::flow::{AuthUrlInfo, AuthUrlMode};
...
pub struct PluginSignInGuard<'a> {
...
impl PluginSignInPrompt {
    ...
    ///
    /// [`AuthSingleFlight`]: crate::single_flight::AuthSingleFlight
    pub fn arm(
        &self,
...
mod tests {
    ...
    async fn the_login_attempt_and_the_prompt_share_one_pair_of_channels() {
        use crate::single_flight::{AttemptChannels, AuthSingleFlight};
