...
pub use xai_grok_memory::{
    ...
    archive, backend, chunker, dream, dream_lock, embed_missing_chunks, embedding, entry, import,
    index, init_sqlite_vec, mmr, noop_memory_observation_sink, query_expansion,
    regenerate_scope_manifest, schema, search, storage, text_utils, v2, watcher,
};
