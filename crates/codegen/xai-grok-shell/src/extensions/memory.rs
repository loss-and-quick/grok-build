//! Extension handlers for `x.ai/compact_conversation`, `x.ai/memory/flush`, `x.ai/memory/note`,
//! `x.ai/memory/rewrite`, `x.ai/memory/list`, `x.ai/memory/toggle`, and `x.ai/memory/forget`.
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        MEMORY_NOTE_METHOD => handle_note(agent, args).await,
...
pub const MEMORY_NOTE_METHOD: &str = "x.ai/memory/note";
