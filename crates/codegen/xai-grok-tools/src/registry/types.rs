...
impl ToolRegistryBuilder {
    ...
    pub fn new() -> Self {
        ...
        b.register::<grok_build::MessageParentTool>();
        ...
        b.register::<crate::implementations::memory::delete_tool::MemoryDeleteImpl>();
...
mod tests {
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::grok_build::{
            IMAGE_GEN_TOOL_NAME, IMAGE_TO_VIDEO_TOOL_NAME, MESSAGE_PARENT_TOOL_NAME,
            MESSAGE_SUBAGENT_TOOL_NAME, REFERENCE_TO_VIDEO_TOOL_NAME, SCHEDULER_CREATE_TOOL_NAME,
