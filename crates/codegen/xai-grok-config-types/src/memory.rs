...
pub struct MemorySettings {
    ...
    pub index_injection: Option<MemoryIndexInjectionSettings>,
...
/// Settings mirror for `[memory.index_injection]`.
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
#[serde(default)]
pub struct MemoryIndexInjectionSettings {
    pub enabled: Option<bool>,
}
...
impl MemoryConfig {
    ...
    pub fn resolve_settings(
        ...
        let index_injection = memory.index_injection.as_ref();
        ...
        Self {
            ...
            index_injection: MemoryIndexInjectionConfig {
                enabled: index_injection
                    .and_then(|settings| settings.enabled)
                    .unwrap_or(defaults.index_injection.enabled),
            },
