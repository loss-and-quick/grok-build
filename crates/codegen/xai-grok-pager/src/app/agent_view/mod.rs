...
pub struct AgentView {
    ...
    /// generation-guarded two-second window the native sign-in copy uses.
    pub(crate) plugin_panel_copy_delivery: Option<crate::clipboard::ClipboardDelivery>,
    /// Bumped per copy so a stale timeout cannot clear a newer copy's feedback.
    pub(crate) plugin_panel_copy_generation: u64,
