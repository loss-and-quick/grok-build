...
use super::auth::{
    dispatch_cancel_login, dispatch_choose_auth_method, dispatch_close_auth_method_picker,
...
use super::settings::setters::{
    ...
    set_subagent_model_inheritance, set_theme, set_timeline, set_timestamps, set_vim_mode,
...
fn dispatch_inner(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SendPromptNow {
            ...
            chip_elements,
            image_notice,
        } => super::interject::dispatch_send_prompt_now(
            app,
            text,
            images,
            chip_elements,
        ...
        Action::SetPluginSetting { key, value } => set_plugin_setting(app, key, value),
        ...
        Action::ChooseAuthMethod {
            method_id,
            switch_account,
        } => dispatch_choose_auth_method(app, method_id, switch_account),
        Action::CloseAuthMethodPicker => dispatch_close_auth_method_picker(app),
