    ...
    loop {
        ...
        tokio::select! {
            ...
            result = async {
                ...
                let fire_modes: std::collections::HashMap<_, _> = outcome
                    .loads
                    .iter()
                    .filter_map(|l| l.scheduler_background_loops.map(|mode| (l.agent_id, mode)))
                    .collect();
                ...
                for id in &pending.agent_ids {
                    ...
                    if let Some(agent) = app.agents.get_mut(id) {
                        ...
                        if let Some(mode) = fire_modes.get(id) {
