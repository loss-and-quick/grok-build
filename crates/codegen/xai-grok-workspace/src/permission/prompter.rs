...
crate::permission::wire_enum! {
    ...
    pub enum PromptOutcomeKind {
        ...
        // Wire value predates the owner projection: the fork already emits
        // `plugin_deny` for a `permission_ask` plugin denial.
        PolicyDeny => "plugin_deny",
        Cancelled => "cancelled",
        Followup => "followup",
        Error => "error",
    }
...
impl PromptOutcome {
    ...
    pub const fn kind(&self) -> PromptOutcomeKind {
        match self {
            ...
            Self::PolicyDeny(_) => PromptOutcomeKind::PolicyDeny,
...
mod tests {
    ...
    fn prompt_outcome_kind_pins_wire_strings() {
        let cases = [
            ...
            (PromptOutcome::PolicyDeny(String::new()), "plugin_deny"),
